...
public class Ex4_ParImpar {
    public static void main(String[] args) {
        ...
        int max;
        int num;
        System.out.println("Quantos números inteiros usaremos? ");
        max = scan.nextInt(); // similar ao comando leia em C#, aqui ele ler o que é digitado e salva na variável "max"
        do{
            ...
            count++;// contador que adiciona +1 a  cada ciclo de execução. Que esta limitado pela pergunta inicial do código.
